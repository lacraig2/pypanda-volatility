'''
This example demonstrates volatility integration with pypanda. For speed reasons we use volatility to return vmlinux
which is the core object required to look up symbols. This example shows pslist.
'''
import logging, pdb
...
'''
To get volatility to work we make a fake file that is backed by panda memory
'''
...
'''
This fake file is interjected into volatility through their urllib library
'''
class PandaFileHandler(BaseHandler):
	def default_open(self, req):
		print("called default_open with "+str(req.full_url))
...
'''
After this point is the *true* plugin once the stuff above goes into a panda mixin.
'''
